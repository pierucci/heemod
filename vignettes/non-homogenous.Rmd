...
param_np1 <- modify(
  param_standard,
  standardRR = 1 - exp(lambda * rrNP1 * ((markov_cycle - 1) ^ gamma -
                                           markov_cycle ^ gamma))
)
param_np1
```
...
The ICER for a population of women aged 60 can be calculated with the following formula:

$$
\frac{637.9 - 616.0}{14.72 - 14.68} = 547.5
$$

The new treatment costs 547.5 GBP per QALY gained.
