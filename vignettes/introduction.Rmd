...
In order to compare different strategies it is possible to run several models in parallel, examples are provided in `vignette("homogenous", package = "heemod")` or `vignette("non-homogenous", package = "heemod")`.
