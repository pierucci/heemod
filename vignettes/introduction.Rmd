...
This transition matrix can be declared with the following command:
...
By default the model is run for one individual starting in the first state (here state `A`).
