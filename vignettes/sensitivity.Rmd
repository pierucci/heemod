...
This example uses the HIV drug model defined in `vignette("homogenous", package = "heemod")`. Read this vignette to find an explanation of the model.

In this example we will study sensitivity to 4 parameters:
