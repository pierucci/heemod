...
`res_mod`, the result we obtained from `run_models()` in the *Time-varying Markov models* vignette, can be passed to `update()` to update the model with the new data and perform the heterogeneity analysis.
