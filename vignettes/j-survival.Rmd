...
+ Take the maximum of the event rate of two (or more) survival distributions: `maximize hazards`
...
max_risk = maximize_hazards(fitw, fitspl)
...
ps <- define_part_surv(
  pfs = surv_dist1 %>%
    maximize_hazards(km1 %>% project(fitw, at = 730)),
  os = km1 %>%
    project(fitw, at = 730),
