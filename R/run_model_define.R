...
#' 
#' `state_time_limit` can be specified in 3 different 
...
#' given state names, for all strategies. 3. As a named list
#' of named vectors: the limits are applied to the given
#' state names for the given strategies.
#' 
